...
![Version](https://img.shields.io/badge/version-0.0.1b-green)
...
Whilst the application will be available to be downloaded from the [Google Play Store](https://play.google.com/) _soon_, you'll always be able to build it by yourself. To do so, just type the following line in your terminal, read the instructions carefully, and let the script do the job for you!  
...
Below are some screenshots of the sections you might find in the application.

<details>
  <summary>Loading screen & Main Menu</summary>
  <img src="https://i.imgur.com/HyCx7Pc.png" width="60%">
</details>

<details>
  <summary>Settings & Tower Selection</summary>
  <img src="https://i.imgur.com/JwSpUyS.png" width="60%">
</details>

<details>
  <summary>In-Game Battle (BETA)</summary>
  <img src="https://i.imgur.com/uNPtJD0.png" width="40%">
</details>

<br>

### Demo
You can check out a quick demo of our game at our [Figma Board](https://www.figma.com/design/9jw3jw3joOSoxgwDHrZJPJ/TFG---The-Climb-Within?node-id=0-1&p=f&t=ACvc9rAuDfr9QYCY-0)
...
### Acknowledgments
This project uses [Lottie for Android](https://github.com/airbnb/lottie-android), which is licensed under the [Apache License 2.0](https://www.apache.org/licenses/LICENSE-2.0).
